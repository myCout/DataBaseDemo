...
#define HDataBaseName     @"DataBaseDemo"
...
+ (NSString *)dbPathWithDirectoryName:(NSString *)directoryName
{
    ...
    if (directoryName == nil || directoryName.length == 0) {
        docsdir = [docsdir stringByAppendingPathComponent:HDataBaseName];
    } else {
    ...
    NSString *dbpath = [docsdir stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.sqlite",HDataBaseName]];
    NSLog(@"dbpath = %@",dbpath);
    return dbpath;
}
